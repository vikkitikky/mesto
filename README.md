...
1) Добавлено четыре класса: для валидации форм, контентных карточек, попапов, попапов с формами
2) Использовано наследование для расширения функционала класса попапов
3) Произведен рефакторинг кода в соответствии с новыми классами
